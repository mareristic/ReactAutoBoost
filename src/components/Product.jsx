...
import openModal from './actions/modalFunction';
//check Line 63 or import good images :D
...
function Product({product}) {
  ...
  return (
    <ProductWrapper className="col-9 mx-auto col-md-6 col-lg-3 my-3">
      <div className="card">
        <div className="img-container p-5" onClick={()=>dispatch(handleDetails(product.id))}>
            <Link to="/details">
